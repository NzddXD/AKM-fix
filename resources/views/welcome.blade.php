    ...
    <body class="bg-gray-900">
        <div class="min-w-full h-screen flex flex-col items-center justify-center p-10">
            <div class="min-w-full min-h-full rounded-lg p-8 flex flex-row items-center text-white relative">
                ...
                <a href="{{ route('login') }}" class="p-3 m-4 rounded-md bg-cyan-700 hover:bg-cyan-800 absolute bottom-0 right-0 hover:outline-2 hover:outline-cyan-800 hover:outline-offset-4 ease-in-out">Log In</a>
            </div>
        </div>
